...
namespace XML
{
    internal class Program
    {
        ...
        {
            XElement PrviXML = XElement.Load(@"C:\Users\Ramseeys\source\repos\XML\XML\prvi.xml");
            XElement DrugiXML = XElement.Load(@"C:\Users\Ramseeys\source\repos\XML\XML\drugi.xml");
            int brojpomagalo = 0;
